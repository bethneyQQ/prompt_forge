...
# Load environment variables (check both project root and prompt_forge/)
env_paths = [
    Path(__file__).parent.parent / ".env",
    Path(__file__).parent.parent / "prompt_forge" / ".env",
]
...
# Paths
DOCS_DIR = Path(__file__).parent.parent / "prompt_forge" / "docs"
